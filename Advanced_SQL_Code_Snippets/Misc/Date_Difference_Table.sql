...
BEGIN
    ...
    ----------------------------------------------------------------
    --Remove the following three variables if creating a function !!!!
    DECLARE @DateDifference TABLE (YearDifference INT, MonthDifference INT, DayDifference INT, HourDifference INT, MinuteDifference INT, SecondDifference INT, NanoDifference INT);
    DECLARE @DateTime1 AS DATETIME2;
    DECLARE @DateTime2 AS DATETIME2;

    SET @DateTime1 = CAST('20230618 00:12:00.0000001' AS DATETIME2);
    SET @DateTime2 = CAST('20110619 00:00:00.0000000' AS DATETIME2);
    ----------------------------------------------------------------
