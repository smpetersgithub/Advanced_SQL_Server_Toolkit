...
def main():
    ...
    sql_file = os.path.join(base_dir, config.get_dependency_sql_script_reverse())
    output_file = os.path.join(output_dir, config.get_object_dependency_list_reverse_json())
    ...
    log_filename = f'log_04_generate_dependency_report_reverse_{timestamp}.log'
    ...
    # Load SQL script
    logging.info("Loading reverse dependency SQL script...")
