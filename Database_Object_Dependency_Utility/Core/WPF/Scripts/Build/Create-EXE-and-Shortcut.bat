...
set "OUTPUT_EXE=%BUILD_DIR%\Database Object Dependency Utility.exe"
set "ICON_PATH=%WPF_DIR%\Assets\icons8-connect-ico.ico"
set "XAML_FILE=%SCRIPTS_DIR%\MainWindow.xaml"

set "SHORTCUT_NAME=Database Object Dependency Utility.lnk"
set "SHORTCUT_SOURCE=%BUILD_DIR%\%SHORTCUT_NAME%"
set "SHORTCUT_DEST=%PROJECT_ROOT%\%SHORTCUT_NAME%"

:: --- Kill EXE if running ---
taskkill /IM "Database Object Dependency Utility.exe" /F >nul 2>&1
timeout /t 1 >nul
