...
function Initialize-DatabaseObjectDependency {
    ...
    if (Test-Path $script:ConfigJsonPath) {
        $configJson = Get-Content -Path $script:ConfigJsonPath -Raw | ConvertFrom-Json
        if ($configJson.paths.database_config) {
            $script:DatabaseConfigPath = Join-Path $script:ProjectRoot $configJson.paths.database_config
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVEyzt8EGc0UlWGjsJyCYVbXd
# nLugghaOMIIDUDCCAjigAwIBAgIQJDAhS7ot/IdFcBXskCRUAjANBgkqhkiG9w0B
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRt9Z6TNugzbGMT
# nKr5H2FLRDK9FTANBgkqhkiG9w0BAQEFAASCAQBfGO9qMgVACZdTHrgA+G5utqrv
# ARV0RprZPwcz7/P2u9WbFR82DWCMjrDVHF1NfWHIyre5Eexf8EeqH3nD6ewgAle8
# eHrURCs0iNEdtXRlYB8nLhzOP1H53gTXGtXtbxAdjG7ZAwEG09UjhZyee6NH2VPj
# VeFL9D/63LJxQPiuBcN3gS4yXYMeRL1KfQhqunXk0Vho1wD3aXSy8llvt5L1JzEv
# B6AxqMFArBjSrVZGGrkVYN4VS91ExcCoTXmYwP9YabL1vyzVkcqHze0UvPwJzLM3
# 2ot7Vl8Y6SDJXOQWgHtH2c/UzHnHuppLPRAlzGnUjwz/HqD4YCat3O3Nn37eoYID
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI2MDYyNjE1MDI0MFowLwYJKoZIhvcNAQkE
# MSIEIBUM8Y/t3OwzfmRh7XtY56/ANfq1EV+K6BuKiBsMClRZMA0GCSqGSIb3DQEB
# AQUABIICAK+RUH5bLHjwpx0JrXJmhnQN1b1xoxxxeQDodjW6NAwf3Kn8mwHZ0HTC
# xDcbyuXm2PJ5YNBQ9ALn27rEs0bSH42tF8i9GKDzXzh0LNr97chIH+kUkzv78yeg
# StNrFUkR9CazLTq3Dn7C3y7GRR+3YTElGPDEx6zaoSQv+bODZQZsNz1ixHbkzh1A
# vYpdWC0UVdkexSLtHeXFR+G3v2gHTk0YWUwn3JJSH/JutatKj62n3ppiQkvVXE8T
# 7EzQRa7Emun6DlsCGy0DO5BYpFX7W0i2zRlOCbMAT4GYLC/j2jbAudLBpObddK/C
# rwMBL0d7v/hGml8qLyb1kpitB6OgjeuxcrZbCqFowJVFiVo6JPsr/Q3ECw4Xcfb8
# V7dI9L7T4CimmAIkyHgRTYRzgtxuXy+xrj75GUmQCk2uNi5FBjQhTXFp5/FR//YW
# Cl1tO7k35xyK5Kg4HfClwRwzOChbB0pkYzOoflMl7hdqugugWAItN2Ar3/jl3NMw
# U93iXSMNX8ZwXDowI4SLQNNICrb/H1B+T6Sv2J4bbnU4nePsT22389EliWSH0Ok0
# i02ATcCXmlHgoySmuOsisjQSozJkedX6bWdMrQcXBlL5D0DJfJHLl+5BQ2iaHLal
# ciHe4gwOkG5nBAfA3iEbu803RFZ8GC4w9hjfCKNHXWGhE97+yeyX
