...
# Verify the digital signatures of all PowerShell scripts
...
$scripts = Get-ChildItem -Path $ScriptRoot -Filter "*.ps1" -Recurse | Where-Object { $_.Name -ne "Verify-Signatures.ps1" }

Write-Host "[INFO] Verifying signatures for $($scripts.Count) script(s)..." -ForegroundColor Yellow
Write-Host ""
...
foreach ($script in $scripts) {
    ...
    Write-Host "Script: $relativePath" -ForegroundColor Cyan
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8PW7RkkkLdYWuJ/CI3QnPJ/+
# mmOgghaOMIIDUDCCAjigAwIBAgIQJDAhS7ot/IdFcBXskCRUAjANBgkqhkiG9w0B
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSSy9/P7Yjd9KG/
# y10cpwPdGG7RUTANBgkqhkiG9w0BAQEFAASCAQAUoc5Gko2fSGH9Tez1H2XMjwX/
# XR5/qIVT4G+EoPVr/RPwvQe/HXce+h5wM5wueqk3GSmxCVxuzKsg9OFuOwYtjpFy
# 4jxwFUUVcDQ9Laljd5aN+32dwdH3/BEWDkPDTOoy+gDZRcjy8ahG5Fd18hOJuPJK
# RovtGVImFTRbBut+hYI3fjNyfWC31rnx8/Y3QlCUnzuJfnE8ouhqVQ7i6Q3gXCFK
# otUBOnuGWgoVvWTvHufyl1G82Lp1mjRq3zffm1EbcOBfPzydmMjfOb4Z3Vwq5ld0
# yIvxXJRfvvIJ7rVkb1LYEG4t0lfuJTw0JLxtcBuOjB3XeRIcVloK+yMbtjhvoYID
...
# MSIEIAL5t/kIn3RKBiyRl5+YtMsOXfPAFX3NIIGM+hO2xievMA0GCSqGSIb3DQEB
# AQUABIICAJpzp8FaOYLI9JhpGpLSaBpcPxUe+hIuYSCvi0Vkzk0wZnHpgiCJ0v7B
# yvlc2/8nwMZZi06ByC2cxwcUCL4JZLPbKN+AeNf8srKcN57CgZ9w5yt492UhLjML
# Miu+9Ypf1RRzMAwpSXbDqSXkSetWTtJzs28oTSirm7aqzbkAu1/aaob6V+73ZBPs
# AWW7RZa2bs6QJztS0AlAP4lD9XuRz7RugtcwfO/uPO+3y2HfOGyyYhVbglNmF2aJ
# DsflZyYR18xyFW2/2sZtgtqb6XRW8GGakBdqGPhE2RwAjWJnif1Y3XY92mbxOZpP
# 7EuHvgVW5SpX+Vihn+7OYwyxQAHyKDdEuNgbaWFLCqSrkZTsjRN0YlD1U2UN2/jw
# /xPDXrKDQ/mndF2nMGucFArnEdX4sQ4799ievhkL6dPfMJobrmcoCn6XgHo1C4qs
# YwLo3zTCOQx8cakojMbNXcIjPX9tuIRurNxJoaoVhkZsDbuMMe1Q/uIkC1SOAZhn
# es7H5kG7sEvdZPR073l1ihROta6v5Wck/mIVOGrF0XAfRxmc/43p58s293Zj/wVW
# sgsAmIqYKRW4jgj6YSrCDZ2j61j3l2sSftfM2X8DAUmB/+oFpu5Hx8BL916xJnOj
# sIyDf/NEiVkMBY59yzhJj/9Xq5hCtMdTbejf9Z5xyZhX7UBbSxh6
