...
def load_results(results_path):
    ...
    try:
        ...
        logger.error("Please run the 'Classify Dependencies' script first.")
        sys.exit(1)
...
def main():
    ...
    try:
        ...
        logger.info("Creating Functional Dependencies sheet...")
        create_functional_dependencies_sheet(workbook, results, excel_config)

        logger.info("Creating Transitive Dependencies sheet...")
        create_transitive_dependencies_sheet(workbook, results, excel_config)

        logger.info("Creating No Functional Dependencies sheet...")
        create_violations_sheet(workbook, results, excel_config)

        # Save workbook
        logger.info("Saving Excel workbook...")
        ...
        logger.info("Use the UI to open the report.")
        ...
        logger.error(f"Cannot write Excel file: {e}")
        sys.exit(1)
