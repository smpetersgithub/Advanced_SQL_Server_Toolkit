...
def execute_sql_query(sql_file_path, connection_string, logger, top_n_queries=10, connection_timeout=10):
...
def main():
    ...
    try:
        ...
        results = execute_sql_query(sql_file_path, connection_string, logger, top_n_queries, config.get_connection_timeout())
